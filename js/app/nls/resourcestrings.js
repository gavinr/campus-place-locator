...
define({
    root: ({
        ...
        //Bookmarks widget
        bookmarksLabel: 'Choose a building',
        bookmarksText: 'Choose a building',


        //Floor Picker
        floorPickerScrollUpTitle: 'Scroll Up',
        floorPickerChangeFloorsTitle: 'Change Floors',
        floorPickerScrollDownTitle: 'Scroll Down',

        //Layer Search
        layerSearchTitle: 'Search',
        layerSearchPlaceholder: 'Search for rooms and people',
        layerSearchButtonTitle: 'Search for Rooms and People',

        //Popup Window
        popupViewCloseButtonTitle : 'Close',

        //Info
        infoButtonTitle: 'More Info',
